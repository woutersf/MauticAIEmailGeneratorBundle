...
namespace MauticPlugin\MauticAIEmailGeneratorBundle\EventListener;
...
class ButtonSubscriber implements EventSubscriberInterface
{
    ...
    public function injectGenerateButton(CustomButtonEvent $event): void
    {
        ...
        if ('mautic_email_index' !== $currentRoute) {
            return;
        }

        $event->addButton([
            'attr' => [
                'href'  => $this->router->generate('mautic_ai_email_generator_generate'),
